...
base_deps = ['requests']
azure_deps = ['requests-oauthlib', 'adal==1.2.7', 'azure-cli-core==2.42.0', 'azure-common==1.1.28', 'azure-mgmt-authorization==2.0.0', 'azure-mgmt-compute==27.1.0', 'azure-identity==1.10.0', 'azure-mgmt-msi==6.0.1', 'azure-mgmt-network==20.0.0', 'azure-mgmt-resource==21.1.0b1', 'azure-mgmt-storage==20.0.0', 'azure-storage-blob==12.11.0', 'azure-storage-queue==12.2.0', 'azure-storage-common==2.1.0', 'knack==0.10.0', 'msrest==0.7.1', 'msrestazure==0.6.4']
